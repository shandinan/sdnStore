...
{
    public static class sdnFileOperation
    {
        #region 引用API，c#封装API
        /// <summary>
        /// 映射API方法
        /// </summary>
        ...
        public static int Copy(IEnumerable<string> sourceFiles, IEnumerable<string> targetFiles, bool deleteSourceFile)
        {
            ...
            pm.pTo += FILE_SPLITER;
            pm.fFlags = FILEOP_FLAGS.FOF_NOCONFIRMATION | FILEOP_FLAGS.FOF_MULTIDESTFILES | FILEOP_FLAGS.FOF_ALLOWUNDO | FILEOP_FLAGS.FOF_NOCONFIRMMKDIR;

           // pm.fAnyOperationsAborted = true;
